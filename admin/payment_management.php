...
<div class="card mb-6">
    ...
    <div class="card-body">
        <div class="flex items-center gap-4 integration-mobile">
        ...
        <div class="mobile-payments-grid">
            <?php if (empty($payments)): ?>
                <div class="mobile-payment-card">
                    <div class="text-center py-4 text-muted">Nenhum pagamento registrado</div>
                </div>
            <?php else: ?>
                <?php foreach ($payments as $payment): ?>
                    <div class="mobile-payment-card">
                        <div class="mobile-card-header">
                            ...
                            <div class="mobile-card-info">
                                <h3><?php echo htmlspecialchars($payment['username']); ?></h3>
                                <p class="mobile-amount">R$ <?php echo number_format($payment['transaction_amount'], 2, ',', '.'); ?></p>
                            </div>
                            <div class="mobile-card-id">
                                <span class="mobile-detail-label">ID</span>
                                <span class="mobile-detail-value">#<?php echo $payment['id']; ?></span>
                            </div>
                        </div>
                        ...
                        <div class="mobile-card-details">
                            ...
                            <div class="mobile-detail-item">
                                <span class="mobile-detail-label">Método</span>
                                <span class="mobile-detail-value"><?php echo $payment['payment_method'] ? ucfirst($payment['payment_method']) : '-'; ?></span>
                            </div>
                            
                            <div class="mobile-detail-item">
                                <span class="mobile-detail-label">Data do Pagamento</span>
                                <span class="mobile-detail-value">
                                    <?php echo $payment['payment_date'] ? date('d/m/Y H:i', strtotime($payment['payment_date'])) : date('d/m/Y H:i', strtotime($payment['created_at'])); ?>
                                </span>
                            </div>
                            
                            <div class="mobile-detail-item">
                                <span class="mobile-detail-label">ID Preferência</span>
                                <span class="mobile-detail-value" style="font-size: 0.75rem; word-break: break-all;">
                                    <?php echo htmlspecialchars($payment['preference_id']); ?>
                                </span>
                            </div>
                        </div>
                        
                        <div class="mobile-card-actions">
                            <button class="mobile-action-btn mobile-action-primary check-payment" data-preference-id="<?php echo $payment['preference_id']; ?>">
                                <i class="fas fa-sync-alt"></i>
                                Verificar Status
                            </button>
                            
                            <a href="edit_user.php?id=<?php echo $payment['user_id']; ?>" class="mobile-action-btn mobile-action-secondary">
                                <i class="fas fa-user-edit"></i>
                                Editar Usuário
                            </a>
                        </div>
