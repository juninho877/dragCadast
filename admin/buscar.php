                    ...
                    <div class="theme-options-grid">
                        ...
                        <div class="theme-option" data-theme="1" onclick="selectTheme(1)">
                            <div class="theme-preview">
                                <img src="https://i.ibb.co/tTG2H5g6/banner-Velozes-Furiosos-10-tema1-1.png" alt="Tema 1" loading="lazy">
                            </div>
                        ...
                        <div class="theme-option" data-theme="2" onclick="selectTheme(2)">
                            <div class="theme-preview">
                                <img src="https://i.ibb.co/cKX3FRc6/banner-Velozes-Furiosos-10-tema2.png" alt="Tema 2" loading="lazy">
                            </div>
                        ...
                        <div class="theme-option" data-theme="3" onclick="selectTheme(3)">
                            <div class="theme-preview">
                                <img src="https://i.ibb.co/LDRmdxDt/banner-Velozes-Furiosos-10-tema3.png" alt="Tema 3" loading="lazy">
                            </div>
