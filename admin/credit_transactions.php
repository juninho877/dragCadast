                    ...
                    <div class="mobile-transaction-card">
                        <div class="mobile-card-header">
                            <div class="mobile-card-info">
                                ...
                                <p>ID: #<?php echo $transaction['id']; ?> • <?php echo date('d/m/Y H:i', strtotime($transaction['transaction_date'])); ?></p>
                            </div>
                            <div class="mobile-card-amount <?php echo $transaction['amount'] > 0 ? 'text-success-500' : 'text-danger-500'; ?>">
                                <?php echo $transaction['amount'] > 0 ? '+' : ''; ?><?php echo $transaction['amount']; ?>
                            </div>
                        </div>
                        ...
                        <div class="mobile-card-details">
                            ...
                            <div class="mobile-detail-item">
                                <span class="mobile-detail-label">Quantidade</span>
                                <span class="mobile-detail-value <?php echo $transaction['amount'] > 0 ? 'text-success-500' : 'text-danger-500'; ?>">
                                    <?php echo $transaction['amount'] > 0 ? '+' : ''; ?><?php echo $transaction['amount']; ?> créditos
                                </span>
                            </div>
                        </div>
                        
                        <div class="mobile-description">
                            <span class="mobile-detail-label">Descrição</span>
                            <div><?php echo htmlspecialchars($transaction['description']); ?></div>
                        </div>
                        
                        <?php if ($transaction['related_entity_id'] || $transaction['related_payment_id']): ?>
                            <div class="mobile-related-section">
                                <span class="mobile-detail-label">Relacionado a</span>
                                <div class="mobile-detail-value">
                                    ...
                                    <?php elseif ($transaction['related_payment_id']): ?>
                                        <span class="payment-id" title="ID do Pagamento">
                                            Pagamento: <?php echo substr($transaction['related_payment_id'], 0, 15) . '...'; ?>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
